...
namespace Only_Bikes.Migrations
{
    ...
    [Migration("20241018205549_AddMaxLengthToUserRoleName")]
    partial class AddMaxLengthToUserRoleName
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Only_Bikes.Entities.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Admin",
                            PasswordHash = "LVdI6+y0J6gl07Lm2vi3cO36Tc6VhD7H831E8qXaf38=",
                            PasswordSalt = "bIszapWIy/cVWG0x/h4yfA==",
                            RoleId = new Guid("242b4de4-e0b2-46ed-89a5-f298a1df047f")
                        });
                });
            ...
            modelBuilder.Entity("Only_Bikes.Entities.User", b =>
                {
                    b.HasOne("Only_Bikes.Entities.UserRole", "Role")
                        .WithMany()
